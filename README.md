# gkeep-list-deadlines

Manage deadlines for Google Keep list items

This contains 2 parts:
- A Google Apps Script service which performs google-based actions (send email, handle responses)
- A Docker container which monitors Keep notes and triggers those actions

## Set up local repo
* Clone git repo: `git clone https://github.com/davidlang42/gkeep-list-deadlines.git`
